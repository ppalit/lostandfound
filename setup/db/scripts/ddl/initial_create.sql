...
create table item_primary(item_id varchar(40),category varchar(20),sub_category varchar(20),public_description varchar(400),secret_description varchar(300), item_found_date datetime default current_timesatmp, street_address varchar(100), lat varchar(20), lng varchar(20), loc_type varchar(10), city varchar(50), country varchar(50), state varchar(80));
